        ...
        <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
            <div class="flex flex-col items-center max-w-sm mx-auto text-center">
                ...
                <p class="mt-4 text-gray-500">
                    Trang bạn đang tìm kiếm không tồn tại. Dưới đây là một số liên kết hữu ích:
                </p>
                ...
                <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                    ...
                    <NuxtLink to="/"
                        class="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 text-center">
                        Về trang chủ
                    </NuxtLink>
                </div>
            </div>
